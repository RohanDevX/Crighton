    ...
    <div className="superbike-layout">
      ...
      <div className="stats-row">
        <div className="stat-block left-block">
          <h1 className="stat-large">220HP FOR</h1>
          <h2 className="stat-medium">129.5KG DRY</h2>
        ...
        <div className="stat-block middle-block">
          <h1 className="stat-large">319HP/LITRE AND</h1>
          <h2 className="stat-medium">1.68HP PER KG</h2>
        ...
        <div className="stat-block right-block">
          <h1 className="stat-large">105FT/LBS AT</h1>
          <h2 className="stat-medium">9,500RPM</h2>
